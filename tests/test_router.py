...
class TestDetectProject:
    ...
    def test_detect_portfolio(self) -> None:
    ...
    def test_detect_sarau(self) -> None:
    ...
    def test_detect_music_connect(self) -> None:
    ...
    def test_detect_hermes_terminal(self) -> None:
    ...
    def test_detect_hermes_credential(self) -> None:
    ...
    def test_detect_hermes_broker(self) -> None:
